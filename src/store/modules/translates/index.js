...
const state = {
  translates: {
    ...
    '출입국관리사무소': '출입국관리사무소',
    '고용복지플러스센터': '고용복지플러스센터',
    '기관을 1개 이상 선택해 주세요': '기관을 1개 이상 선택해 주세요',
    '주소': '주소',
    '운영시간': '운영시간',
    '지원언어': '지원언어',
    '기관명': '기관명',
    ...
    '기획 및 자료관리 : 강영준, 구본석, 김동현, 박산, 임주연, 강준희, 김지수, 예윤지, 이시원, 이유진': '기획 및 자료관리 : 강영준, 구본석, 김동현, 박산, 임주연, 강준희, 김지수, 예윤지, 이시원, 이유진',
    '개발 : 윤치호': '개발 : 윤치호',
